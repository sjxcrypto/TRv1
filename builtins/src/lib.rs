...
pub static BUILTINS: &[BuiltinPrototype] = &[
    ...
    // ── TRv1 custom programs ─────────────────────────────────────────────
    BuiltinPrototype {
        core_bpf_migration_config: None,
        name: "passive_stake_program",
        enable_feature_id: None,
        program_id: solana_passive_stake_program::id(),
        entrypoint: solana_passive_stake_program::processor::Entrypoint::vm,
    },
    BuiltinPrototype {
        core_bpf_migration_config: None,
        name: "treasury_program",
        enable_feature_id: None,
        program_id: solana_treasury_program::id(),
        entrypoint: solana_treasury_program::processor::Entrypoint::vm,
    },
    BuiltinPrototype {
        core_bpf_migration_config: None,
        name: "developer_rewards_program",
        enable_feature_id: None,
        program_id: trv1_developer_rewards_program::id(),
        entrypoint: trv1_developer_rewards_program::processor::Entrypoint::vm,
    },
];
